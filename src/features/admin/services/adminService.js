...
export async function getAdminMetrics() {
  try {
    ...
    throw new Error(error.response?.data?.message || "Failed to fetch platform metrics.", { cause: error });
  }
}
...
export async function getPendingHackathons() {
  try {
    ...
    throw new Error(error.response?.data?.message || "Failed to fetch pending hackathons.", { cause: error });
  }
}
...
export async function approveHackathon(id) {
  try {
    ...
    throw new Error(error.response?.data?.message || "Failed to approve hackathon.", { cause: error });
  }
}
...
export async function rejectHackathon(id) {
  try {
    ...
    throw new Error(error.response?.data?.message || "Failed to reject hackathon.", { cause: error });
  }
}
...
export async function banUser(email) {
  try {
    ...
    throw new Error(error.response?.data?.message || "Failed to ban user.", { cause: error });
  }
}
...
export async function unbanUser(email) {
  try {
    ...
    throw new Error(error.response?.data?.message || "Failed to unban user.", { cause: error });
  }
}
